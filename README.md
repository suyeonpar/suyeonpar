...
HTML5, CSS3, Tailwind CSS, SCSS, JavaScript, TypeScript, node.js, Next.js 잘하는 개발자 입니다.

저는 모든것들을 아름답게 발전시키고 싶습니다.
